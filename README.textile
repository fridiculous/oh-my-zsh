...
@curl -L https://raw.github.com/simonfrid/oh-my-zsh/master/tools/install.sh | ZSH=~/.dotfiles/zsh sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/simonfrid/oh-my-zsh.git ~/.oh-my-zsh@
...
* enable the plugins you want in your @~/.zshrc@ (take a look at the @plugins/@ directory and the "wiki":https://github.com/simonfrid/oh-my-zsh/wiki/Plugins to see what's possible)
** example: @plugins=(git osx ruby)@
* Theme support: Change the @ZSH_THEME@ environment variable in @~/.zshrc@.
** Take a look at the "current themes":https://wiki.github.com/simonfrid/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
...
also a short "one":http://ivan.kanis.fr/zsh.pdf
...
* "View our growing list of contributors":https://github.com/simonfrid/oh-my-zsh/contributors
